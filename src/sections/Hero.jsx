...
const Hero = () => {
  return (
    <section className="flex flex-col lg:flex-row justify-between items-center gap-4 w-full bg-slate-100 h-auto lg:h-screen">
      <div className="flex justify-center items-start flex-col gap-8 lg:w-1/2 px-10 py-20 lg:py-20">
        ...
        <p className="text-slate-900 text-2xl">
          ...
          recusandae aut dignissimos consequuntur deleniti excepturi consectetur
          temporibus itaque animi magnam.
        </p>
